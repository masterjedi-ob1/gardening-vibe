...
> _In memory of **Beatrice McCarthy** — the family green thumb, always in the garden._
...
- `CLAUDE.md` — project guide for Claude Code & humans
- `docs/PROJECT_PLAN.md` — vision, MVP, stack, roadmap, open questions
- `docs/RESEARCH_APPS.md` — competitive landscape (Planta, Seed to Spoon, Plantix, …)
- `docs/RESEARCH_VISION.md` — plant-health vision: datasets, models, costs
- `docs/AI_MODELS.md` — chosen free/local/cheap models (Hugging Face picks)
